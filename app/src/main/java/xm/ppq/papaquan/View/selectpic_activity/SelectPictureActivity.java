...
package xm.ppq.papaquan.View.selectpic_activity;
...
public class SelectPictureActivity extends SunActivity {
...
//    private DisplayImageOptions options;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RequestpermissionUtil.requestCameraPermission(this, null);
...
//                loader.displayImage("file://" + item.path, holder.iv, options);
                ImageLoading.common(SelectPictureActivity.this, "file://" + item.path, holder.iv, R.drawable.white);
...
//            loader.displayImage("file://" + item.getFirstImagePath(), holder.id_dir_item_image, options);
            ImageLoading.common(SelectPictureActivity.this, "file://" + item.getFirstImagePath(), holder.id_dir_item_image, R.drawable.white);
