...
public class NewsFragMent extends LoadingOneFragment implements Round_Topicdetail, Round_papa_news, UpMoreInterface {

    @BindView(R.id.topic_news_recycler)
    RecyclerView topic_news_recycler;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            view = inflater.inflate(R.layout.fragment_topicnews, container, false);
    ...
    public void setListener() {
        ...
        topic_news_recycler.addOnScrollListener(onScrollListener);
    }
    ...
    public void startMutual() {
        mutual_topicDetail.setFragment(round_topicdetail.getHotid(), "1");
    }
    ...
    public void setList(ArrayList<ShowNewsBigBean.Data> datas) {
        ...
        if (adapter == null) {
            ...
            topic_news_recycler.setLayoutManager(new LinearLayoutManager(getContext()));
            topic_news_recycler.setAdapter(adapter);
        } else {
