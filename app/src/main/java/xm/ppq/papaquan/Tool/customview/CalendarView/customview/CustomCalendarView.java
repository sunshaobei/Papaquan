package xm.ppq.papaquan.Tool.customview.CalendarView.customview;
...
import xm.ppq.papaquan.Tool.customview.CalendarView.adapter.CalendarGridViewAdapter;
...
import xm.ppq.papaquan.Tool.customview.CalendarView.util.inject.ViewInject;
...
public class CustomCalendarView extends LinearLayout {
    ...
    public CustomCalendarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.attrs=attrs;
        view = LayoutInflater.from(getContext()).inflate(R.layout.custom_calendarview,null);
        left = (ImageView) view.findViewById(R.id.calendarview_imgbutton_left);
        right = (ImageView) view.findViewById(R.id.calendarview_imgbutton_right);
        moth = (TextView) view.findViewById(R.id.calendarviewtext_month);
        gridView = (GridView) view.findViewById(R.id.calendarview_grid_gridview);
        ViewInject.inject(this, view);
        addView(view);
        Calendar calendar=Calendar.getInstance();
        calendar.setTime(new Date());
    ...
    private void inite(int year, int month){
        ...
        left.setOnClickListener(v -> {
            setLeftOnclick();
            onChangYearMonthListener.onClick();
        });
    ...
    public interface OnChangYearMonthListener{
        void onClick();
    }
    private OnChangYearMonthListener onChangYearMonthListener;
    public void setOnChangYearMonthListener(OnChangYearMonthListener o)
    {
        this.onChangYearMonthListener = o;
    }
