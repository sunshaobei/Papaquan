...
/**
 * 聊天界面自带提供两种主题的自定义供用户方便的使用，用户可以通过{@link CustomSampleHelper｝中 实现 AdviceBinder.bindAdvice(PointCutEnum.CHATTING_FRAGMENT_UI_POINTCUT, ChattingUI.class);
...
//        }
    ...
    public View getCustomTitleView(final Fragment fragment,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        {
            ...
            window.setStatusBarColor(Color.parseColor("#e60012"));
        }
...
//                + "/alibaba/WXOPENI/云旺相册";
    ...
    private void receiveTribeMsg(YWTribe tribe, final View view) {
        IMUtils.getIMKit().getIMCore().getTribeService().unblockTribe(tribe, new IWxCallback() {
            @Override
...
//            plugin.setOnClickListener(new View.OnItemClickListener() {
//                @Override
//                public void onClick(View v) {
