 ...
 */
public class DownloadImageTask extends AsyncTask<String, Void, DownloadImageTask.WH> {
    ...
    public DownloadImageTask(CustomImageView onimage, String url, Activity activity) {
        this.onimage = onimage;
        this.activity = activity;
        this.url = BaseUrl.BITMAP + url + "/dantu";
    }

    public DownloadImageTask(CustomImageView onimage, String url, Activity activity, int i) {
        this.onimage = onimage;
        if (i == 0) {
            this.url = BaseUrl.BITMAP + url + "/dantu";
        } else {
