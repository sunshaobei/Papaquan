...
//            Intent intent = new Intent(TakeVideoActivity.this, EditVideoActivity.class);
//            intent.putExtra("path", MyApplication.VIDEO_PATH + "/finish.mp4");
//            startActivityForResult(intent, REQUEST_KEY);

            Intent intent = getIntent();
            //视频路径
            intent.putExtra("videoPath", MyApplication.VIDEO_PATH + "/finish.mp4");
            //图片路径
